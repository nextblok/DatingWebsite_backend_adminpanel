...
const Login = ({ credential, LoginSuccess, LogOutSuccess }) => {
  const [state, setState] = React.useState({ public: "admin@gmail.com", password: "" });
  ...
  const initialize = async () => {
    const response = await ApiCall(apiConfig.initialize.url, apiConfig.initialize.method, "", {});
            ...
            <Form className="form">
              ...
              >
                ...
                <CardBody>
                  ...
                  <Button color="btn1 btn-sm" onClick={initialize}>Initialize</Button>
                </CardBody>
                <CardFooter>
                  {/* <a
                    href="/auth/register"
