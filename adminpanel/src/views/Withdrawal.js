...
const Page = ({ credential }) => {
    ...
    (async () => {
      try {
        ...
        var response = await ApiCall(
          apiConfig.withdrawal_get.url,
          apiConfig.withdrawal_get.method,
  ...
  const save = async (data) => {
    try {
      ...
      const response = await ApiCall(
        apiConfig.withdrawal_upsert.url,
        apiConfig.withdrawal_upsert.method,
        credential.loginToken,
        data
      );
      if (response.data.success) {
  ...
  const remove = async (data) => {
    try {
      const response = await ApiCall(
        apiConfig.withdrawal_del.url,
        apiConfig.withdrawal_del.method,
        credential.loginToken,
        data
      );
      if (response.data.success) {
    ...
    <>
      ...
      <div className="content">
        <Card>
          ...
          <CardBody>
            <span>Total Withdrawals: {data.length}</span>
